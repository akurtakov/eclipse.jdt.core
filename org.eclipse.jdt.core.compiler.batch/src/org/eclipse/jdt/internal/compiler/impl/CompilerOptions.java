...
public class CompilerOptions {
	...
	static final String[] DEFAULT_NULLABLE_ANNOTATION_SECONDARY_NAMES = { "javax.annotation.Nullable", "jakarta.annotation.Nullable" }; //$NON-NLS-1$ //$NON-NLS-2$
	static final String[] DEFAULT_NONNULL_ANNOTATION_SECONDARY_NAMES = { "javax.annotation.Nonnull", "jakarta.annotation.Nonnull" }; //$NON-NLS-1$ //$NON-NLS-2$
